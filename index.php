                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Barang Yang Tersedia Kali Ini</li>
                        </ol>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Salah satu headset terbaik di dunia</td>
                                            <td>8</td>
                                        </tr>
                                    </tbody>
                                        <tr>
                                            ...
                                            <td>Headset Gaming terbaik</td>
                                            <td>25</td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td>Iphone 13 Pro</td>
                                            <td>Handphone yang banyak diminati</td>
                                            <td>52</td>
                                        </tr>
                                </table>
                            </div>
